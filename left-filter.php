				<div class="col-md-3 apply_box 1filter_box sticky1" style="padding-left:0px;padding-right:0px;padding-top:0px;">
							...
							<div class="panel-body" >
								...
								<div id="collapse01" class="panel-collapse collapse in" >
									...
									<?php
										...
										$job_type = mysqli_query($db,"select * from cj_job_post where user_id='".$_SESSION["user_id"]."' GROUP BY job_type");
								...
								<div id="collapse1" class="panel-collapse collapse in" >
									...
									<?php
										...
										$company_name = mysqli_query($db,"select * from cj_job_post where user_id='".$_SESSION["user_id"]."' GROUP BY company_name");
								...
								<div id="collapse3" class="panel-collapse collapse in">
									...
									<?php
										...
										$shift = mysqli_query($db,"select * from cj_job_post where user_id='".$_SESSION["user_id"]."' GROUP BY work_shifts");
								...
								<!--div id="collapse2" class="panel-collapse collapse"--><!--auto close-->
									...
									<?php
										...
										$location = mysqli_query($db,"select * from cj_job_post where user_id='".$_SESSION["user_id"]."' GROUP BY location");
