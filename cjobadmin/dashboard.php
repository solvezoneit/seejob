								...
								<div class="col-xs-12">
									...
									<!--<div class="alert alert-block alert-success">
										...
										лёгкий, многофункциональный и простой в использовании шаблон для админки на bootstrap 3.3.6. Загрузить исходники с <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css files).
											...
											<div class="infobox infobox-red infobox-mediam infobox-dark" style="width:100%;height:auto;">
												<div class="infobox-progress">
													<div class="easy-pie-chart percentage" data-percent="10" data-size="39">
														<i class="fa fa-user"></i>
													</div>
												</div>

												<div class="infobox-data">
													<div class="infobox-content"><i class="fa fa-warning"></i> Profile Incomplete</div>
													<a href="profile.php"><div class="infobox-content" style="float:right;border:2px solid white;padding:5px;">Completion</div></a>
												</div>
											</div>
