						...
						<div class="page-content">
							...
							<div class="page-header">
								<h1><a onclick="history.back()"><button type="button" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i>&nbsp;  Back</button></a>&nbsp;  
									...
									<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#create-item">
										  Add Location
									</button>
								</h1>
							</div><!-- /.page-header -->
							...
							<div class="panel1 panel-primary">
								<div class="panel-heading">Location management</div>
								  ...
								  <div class="modal-body">
										<form data-toggle="validator" action="api/create.php" method="POST">
											...
											<div class="form-group">
												<label class="control-label" for="title">Type of location:</label>
												<select name="tl" class="chosen-select form-control" data-error="Select Type of location:" required >
											...
											<div class="form-group">
												...
												<textarea name="description" rows="12" class="form-control" data-error="Please enter description." required></textarea>
												<div class="help-block with-errors"></div>
											</div>
