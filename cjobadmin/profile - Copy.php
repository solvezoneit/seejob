...
if($_SESSION['FLAG']=='1')
{
	$sql = mysqli_query($db,"select * from tbl_merchant where id='$_SESSION[USERID]'") or die(mysqli_error($db));
	...
	if(@$_POST["btnprofile1"]=="Update")
	{
		...
		if(mysqli_query($db,"update tbl_merchant set name='$name',address='$address',contact='$contact',email='$email',website='$website' where id='$_SESSION[USERID]'"))
		{
											...
											<div class="col-xs-12 col-sm-9">
												...
												<form method="POST">
													...
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<span class="editable" id="username1"><input type="text" name="website" value="<?=$row['website']?>" placeholder="Empty" style="border:1px solid white;"></span>
														</div>
													</div>
													<!--div class="profile-info-row">
													...
													<div class="tabbable">
														...
														<div class="tab-content profile-edit-tab-content">
															<div id="edit-basic" class="tab-pane in active">
																...
																<div class="row">
																	...
																	<div class="col-xs-12 col-sm-8">
																		<div class="form-group">
																			...
																			<div class="col-sm-8">
																				<input name="name" class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="Username" value="<?=$row['name']?>" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-8">
																				<input name="bname" class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="Business Name" value="<?=$row['business_name']?>" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-8">
																				<input name="username" class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="Username" value="<?=$row['username']?>" />
																			</div>
																		</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		...
																		<select id="tl" name="tl" class="chosen-select form-control" required>
																			...
																			<?php
																			$sql_country = mysqli_query($db,"select * from country_tbl");
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		...
																		<select id="tl" name="tl" class="chosen-select form-control" required>
																			...
																			{
																				?>
																				<option value="Country"><?=$state["l1"]?></option>
																				<?php
																			}
																			?>
																		</select>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		...
																		<select id="tl" name="tl" class="chosen-select form-control" required>
																			...
																			{
																				?>
																				<option value="Country"><?=$city["l1"]?></option>
																				<?php
																			}
																			?>
																		</select>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		...
																		<input type="text" name="pincode" placeholder="Enter pincode" maxlength="6"  id="pin" pattern="\d{6}" value="<?=$row['pincode']?>" required/>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		<textarea name="location" id="form-field-comment" placeholder="Enter Location" ><?=$row['location']?></textarea>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		<span class="input-icon input-icon-right">
																			<input type="email" name="email" id="form-field-email"  value="<?=$row['email']?>" />
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		<span class="input-icon input-icon-right">
																			<input name="website" type="url" id="form-field-website" value="<?=$row['website']?>" />
																			<i class="ace-icon fa fa-globe"></i>
																		</span>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		<span class="input-icon input-icon-right">
																			<input name="phone" class="input-medium input-mask-phone" type="text" id="form-field-phone" value="<?=$row['contact']?>"/>
															...
															<div id="edit-settings" class="tab-pane">
																...
																<div>
																	<label class="inline">
																		<input name="profile_status" type="checkbox" name="form-field-checkbox" class="ace" />
