					...
					<div class="main-content-inner">
						<div class="breadcrumbs ace-save-state" id="breadcrumbs">
							<ul class="breadcrumb">
								...
								<li>
									<a href="#">Apply Details</a>
								</li>
								<li class="active">View Apply Job</li>
							</ul><!-- /.breadcrumb -->
							...
							<div class="panel1 panel-primary">
								...
								<div class="panel-body1 table-responsive">
									<table class="table table-bordered table-responsive">
										...
										{
											mysqli_query($db,"update cj_apply_job set status='0' where id='".$_REQUEST["status"]."'");
											header("location:apply_job.php");
											exit();
										}
										if(@$_REQUEST["change_statuss"]=='0' && isset($_REQUEST["status"]))
										{
											mysqli_query($db,"update cj_apply_job set status='1' where id='".$_REQUEST["status"]."'");
											header("location:apply_job.php");
											exit();
										}
										...
										$sql_page = "SELECT * FROM cj_apply_job ";
										...
										while($row = mysqli_fetch_array($run_query))
										{
										 ...
										 ?>
											<tr>
												...
												<td><a href="apply_job.php?del=<?php echo $id;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a></td>

		
												<!-- ......................Update Advertise..................... -->

												<div class="modal fade" id="apply_job<?php echo "$cv_id"; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
{
	$val = $_GET['del'];
	$sql = "delete from cj_apply_job where id='$val'";
	$run_sql = mysqli_query($db, $sql);

	echo "<script>alert('Successfully deleted applied job')</script>";
	echo "<script>window.open('apply_job.php','_self')</script>";
}
