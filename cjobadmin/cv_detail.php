					...
					<div class="main-content-inner">
						<div class="breadcrumbs ace-save-state" id="breadcrumbs">
							<ul class="breadcrumb">
								...
								<li class="active">View CV-details</li>
							</ul><!-- /.breadcrumb -->
							...
							<div class="panel1 panel-primary">
								...
								<div class="panel-body1 table-responsive">
									<table class="table table-bordered table-responsive">
										...
										<?php
										if(@$_REQUEST["change_statuss"]=='1' && isset($_REQUEST["cj_status"]))
										{
											mysqli_query($db,"update cj_cv set cj_status='0' where cv_id='".$_REQUEST["cj_status"]."'");
											header("location:cv_detail.php");
											exit();
										}
										if(@$_REQUEST["change_statuss"]=='0' && isset($_REQUEST["cj_status"]))
										{
											mysqli_query($db,"update cj_cv set cj_status='1' where cv_id='".$_REQUEST["cj_status"]."'");
											header("location:cv_detail.php");
											exit();
										}
										...
										$query = "SELECT * FROM `cj_cv` where cv_name LIKE '%".@$_REQUEST["search"]."%' LIMIT $start, $perpage";
										...
										while($row = mysqli_fetch_array($run_query))
										{
											...
											$cv_name = $row['cv_name'];
											$user_id= $row['user_id'];
											$cj_status = $row['cj_status'];
											
											
										 ?>
											<tr>
												<td><?php echo $cv_id; ?></td>
												<td><?php echo $cv_name; ?></td>
												...
												if($cj_status=='1')
												{
												?><a href="?cj_status=<?=$cv_id;?>&&change_statuss=<?=$cj_status?>" class="btn btn-primary btn-xs"><i class="fa fa-check"></i></a><?php
												}else{
												?><a href="?cj_status=<?=$cv_id;?>&&change_statuss=<?=$cj_status?>" class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></a><?php
												}?>
												</div>
												</td>
											
												<td><a href="" class="btn btn-success btn-xs" data-toggle="modal" data-target="#cv_details<?php echo "$cv_id"; ?>"><i class="fa fa-eye"></i> View</a></td>		
												<!-- ......................View CV..................... -->

												<div class="modal fade" id="cv_details<?php echo "$cv_id"; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
												  <div class="modal-dialog" role="document">
													<div class="modal-content modal-md">
													  <div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
														<h4 class="modal-title" id="myModalLabel">CV Details</h4>
													  </div>
													  <div class="modal-body">

														<!--   <h2>Panel Headi</h2> -->
														<?php
															$sql="Select * from cj_cv where cv_id='$cv_id'";
															$run_sql =mysqli_query($db, $sql);
															while($data = mysqli_fetch_array($run_sql))
															{
																$cv_id = $data['cv_id'];
																$cv_name = $data['cv_name'];
																$cv_contact = $data['cv_contact'];
																$cv_resume =$data['cv_resume'];
																$cv_msofc =$data['cv_msofc'];
																$cv_language =$data['cv_language'];
																$cj_salary =$data['cj_salary'];
																$cj_company =$data['cj_company'];
																$cj_experience =$data['cj_experience'];
																$cj_designation =$data['cj_designation'];
																$cj_board =$data['cj_board'];
														...
														<div class="panel-group">
									 					  ...
									 					  <div class="panel panel-primary">
														    <div class="panel-heading"><h5><b>CV Details</b></h5></div>
														    <div class="panel-body">
														    	<label class="control-label" for="title"><b>CV Id: </b><span><?php echo $cv_id; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CV Name: </b><span><?php echo $cv_name; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CV Contact: </b><span><?php echo $cv_contact; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CV Resume: </b><span><?php echo $cv_resume; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CV MSOFC: </b><span><?php echo $cv_msofc; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CV Language: </b><span><?php echo $cv_language; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CJ Salary: </b><span><?php echo $cj_salary; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CJ Company: </b><span><?php echo $cj_company; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CJ Experience: </b><span><?php echo $cj_experience; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CJ Designation: </b><span><?php echo $cj_designation; ?></span></label><br>
														    	<label class="control-label" for="title"><b>CJ Board: </b><span><?php echo $cj_board; ?></span></label><br>
