<?php
	...
	if(isset($_POST["jobclosestatus"]))
	{
		$job_post_id = $_REQUEST["job_post_id"];
		$status = $_REQUEST["jobclosestatus"];
		mysqli_query($db,"UPDATE cj_job_post SET 
		status='$status',
		mod_date=Now() WHERE job_post_id='".$job_post_id."' ");
