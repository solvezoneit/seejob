<?php
	...
	$get_details = mysqli_fetch_array(mysqli_query($db,"select * from cj_pages where url='".$_REQUEST["url"]."'"));
?>
<!DOCTYPE html>
<html lang="en">
	...
	<head>
		...
		{
		margin-top:-20px;
		background-image:url(<?=$url?>/cjobadmin/images/pages/<?=$get_details['banner_img']?>);
			...
			<div class="container">
				<div style="margin-top:30px;">
					<p style="background-color:#1750e8a6;padding:10px;width:83%;">
						...
						<a style="text-decoration:none;color:white;" href="#" class="link_tab">Company</a>&nbsp;
							<i class="fas fa-angle-double-right link_tab"></i>&nbsp;
						<a style="text-decoration:none;color:white;" href="#" class="link_tab"><?=$get_details['name']?></a>&nbsp;
						</span>
					</p>
				</div>
			</div>
			...
			<div class="row employer_detail_margin" style="">
				<div class="col-md-10">
					<div class="apply_box row">
						<div class="col-md-12">
							<h3 style="color:#2e6da4;"><?=$get_details['name']?></h3>
							<hr>
						</div>
						<div class="col-md-12">
							<p align="justify"><?=$get_details['body_part']?></p>
