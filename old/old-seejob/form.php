<form  action="register-basicdetails.php" method="post">
		 <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-8">
                    <input type="text" path="firstName" id="firstName" class="form-control input-sm" placeholder="Enter your First Name"  onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Enter your First Name *';}">
                </div>
            </div>
         </div>
         <div class="row">
