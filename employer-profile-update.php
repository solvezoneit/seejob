					...
					<div>
						<div>
							<div class="row my_heading">
								<h2 class="myprofile_heading"><?=ucwords($profilerow["name"])?></h2>
									<a href="employer-profile.php" class="btn btn-primary my_btn" role="button">Back to Profile</a>
							</div>
						...
						<div class="tab-content">
							<div id="profile" class="tab-pane fade in active profile_menu">
								<form class="form-horizontal" id="my_form" action="php/user.php" method="POST">
									...
									<div class="row">
										<div class="col-md-6  profile_option">
											...
											<div class="row">
											  ...
											  <div class="col-75" style="padding:0px 10px 0px 10px ;">
												<textarea name="address" placeholder="Enter Address.." style="height:auto" required="required"><?=$profilerow['address']?></textarea>
											  </div>
											</div>
											<div class="row">
											  <div class="col-25" style="text-align:left;">
										...
										<div class="col-md-6  profile_option">
											<div class="row">
											  ...
											  <div class="col-75" style="padding:0px 10px 0px 10px ;">
												<textarea id="subject" name="description" placeholder="Write something.." style="height:auto" required="required"><?=$profilerow['description']?></textarea>
											  </div>
											</div>
											<div class="row">
											  <div class="col-25" style="text-align:left;">
									...
									<div class="input-group col-sm-3" style="padding:0px;">
										<input type="hidden" class="form-control" name="employerprofileupdate" value="Update">
										<input type="submit" class="form-control" name="employerprofileupdate" value="Update">
									</div>
									</div>
								</form>
							</div>
									...
									<div class="row">
										...
										<div class="col-lg-8">
											...
											<div class="form-group">
											  <div class="input-group col-sm-3" style="padding:0px;">          
												<input type="hidden" class="form-control" name="changeprofilestatus" value="Update">
												<input type="submit" class="form-control" name="changeprofilestatus" value="Update">
											  </div>
											</div>
										</div>
									</div>
								...
								<form class="form-horizontal" id="my_form_account" action="php/user.php" method="POST">
									<div class="row" style="margin:0px 30px 0px 30px ;">
										...
										<div class="form-group">
										  ...
										  <div class="input-group col-sm-3" style="padding:0px;">          
											<input type="hidden" class="form-control" name="changeprofilesocialmedia" value="Update">
											<input type="submit" class="form-control" name="changeprofilesocialmedia" value="Update">
										  </div>
										</div>
							...
							<div id="Re-pwd" class="tab-pane fade profile_menu3" style="padding:30px;" >
								<form class="form-horizontal" id="my_form_re_pwd" action="php/user.php" method="POST">
									...
									<div class="form-group">
									  <label class="col-sm-3" style="padding:0px;"> </label>
									  <div class="input-group col-sm-6" style="padding:0px;">          
										<input type="hidden" class="form-control" name="changeemployerpwd" value="Update">
										<input type="submit" class="form-control" name="changeemployerpwd" value="Update">
									  </div>
									</div>
								</form> 
							</div>
