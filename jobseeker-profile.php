					...
					<div>
						<div>
							<div class="row my_heading">
								...
								<a href="jobseeker-profile-update.php" class="btn btn-primary my_btn" role="button">Update Profile </a>
							</div>
							<?php
							...
							<p align="justify"><?=$profilerow["description"]?></p>
							<?php
						...
						<div class="col-md-12 text-left up_submit" style="margin-top:50px;">
							<a href="jobseeker-profile-update.php" class="btn btn-default" role="button"><i class="fas fa-edit"></i> Update Your Profile</a>
						</div>
					</div>
				</div>
